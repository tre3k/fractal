...
// Необходимо добавить функцию экспорта графиков в изображение
// как я это уже когда-то делал, по выпадающему списку
...
public:
	...
	void addCurve(QVector<double> *, QVector<double> *,
		      bool, QColor, QString);
...
class iQCustomPlot2D : public iQCustomPlot
{
	Q_OBJECT
public:
	explicit iQCustomPlot2D(QString title = "",
				QWidget *parent = 0);
...
class iCasePlot2D : public QWidget
{
	Q_OBJECT
public:
	explicit iCasePlot2D(QString title = "", QWidget *parent = 0);
